  ...
  return (
    <Card className="h-[104px]">
      <div className="flex gap-4 justify-between grow">
        <Image src='/images/christmas-girl.png' alt="christmas-girl" width={72} height={72} className="rounded-lg"></Image>
        <div className="grow flex flex-col gap-2">
          ...
          <div className={`${outfit.className} flex gap-2 justify-between`}>
            <BidValue title="Latest Bid" value={5.20}></BidValue>
            <BidValue title="Your Bid" value={3.20} active={false}></BidValue>

            {/* TODO: font-family: var(--typography-family-body, "Frutiger Neue for Post"); */}
            <Button className="py-0 px-2 rounded-lg border border-solid border-white text-xs">Bit more</Button>
          </div>
        </div>
      </div>
    </Card>
